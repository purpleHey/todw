(function($){
    $.fn.extend({
        bra_google_map: function(options) {
            ...
            var defaults = {
                google_api: 'AIzaSyD5MaEIDcLwA6qVi7A0k2Um_dZ-g1xJXL4',
                location: '',
				zoom: 4
            };
            ...
            return this.each(function() {
			  ...
			  var wait = setInterval(function() {
				  if( $("#" + obj_id).is(":visible") ) {
					  ...
					  //alert("usao2")
					  var latlng = new google.maps.LatLng(30.278987,-97.742615); // starting default location
					  var myOptions = {
						zoom: o.zoom,
						center: latlng,
...
$(document).ready(function() {
  $('#bra-map').bra_google_map({location: 'University of Texas at Austin', zoom: 15});
});
